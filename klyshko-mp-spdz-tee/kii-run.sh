...
export RA_TLS_ALLOW_DEBUG_ENCLAVE_INSECURE=${RA_TLS_ALLOW_DEBUG_ENCLAVE_INSECURE:-0}
export RA_TLS_ALLOW_OUTDATED_TCB_INSECURE=${RA_TLS_ALLOW_OUTDATED_TCB_INSECURE:-0}
