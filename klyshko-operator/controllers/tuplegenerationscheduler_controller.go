...
func (r *TupleGenerationSchedulerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if r.cleanupFinishedJobs(ctx) != nil {
...
// Deletes all jobs that are done, i.e., either complete or failed
func (r *TupleGenerationSchedulerReconciler) cleanupFinishedJobs(ctx context.Context) error {
	logger := log.FromContext(ctx)
