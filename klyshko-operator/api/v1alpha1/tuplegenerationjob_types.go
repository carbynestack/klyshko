...
type TupleGenerationJobSpec struct {
	...
	// ID is the unique identifier of this job.
	ID string `json:"id"`
	...
	// Type specifies the type of the tuples to be generated by this job.
	Type string `json:"type"`

	//+kubebuilder:validation:Minimum=0
	//+kubebuilder:validation:ExclusiveMinimum=true
	// Count specifies the number of tuples to be generated by this job.
	Count int `json:"count"`

	// Generator is the name of the TupleGenerator that should be used for tuple generation by this job.
	Generator string `json:"generatorRef"`
}
